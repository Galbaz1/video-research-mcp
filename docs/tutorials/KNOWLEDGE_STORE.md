...
The summarizer (`tools/knowledge/summarize.py`) batches up to 20 hits and sends them to Gemini Flash (`gemini-3.6-flash`) with `thinking_level="minimal"` for fast processing.
